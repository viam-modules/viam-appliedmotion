...
| min_rpm* | float64  | The minimum RPM that this motor can run. Set this to 0 to not enforce any minimum speed. |
| max_rpm* | float64  | The maximum RPM that this motor can run. Set this to 0 to not enforce any maximum speed. |
